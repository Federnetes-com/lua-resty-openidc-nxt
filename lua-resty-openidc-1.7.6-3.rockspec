package = "lua-resty-openidc-fixeddependency"
version = "1.7.6-3"
source = {
    url = "git+https://github.com/Federnetes-com/lua-resty-openidc-nxt.git",
    tag = "v1.7.6",
...
description = {
    ...
    homepage = "https://github.com/Federnetes-com/lua-resty-openidc-nxt.git",
    license = "Apache 2.0"
}
dependencies = {
    "lua >= 5.1",
